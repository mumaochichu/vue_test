...
let Notification = (function (Vue, globalOption = {
  ...
  self.full = function (id = '') {
    let el=document.querySelector('#' + id + ' .lv-icon-max')
    el&&el.click();
  }
  /**
   * 手动最小化
  ...
  self.min = function (id = '') {
    let el=document.querySelector('#' + id + ' .lv-icon-mini')
    el&&el.click();
  }
  /**
   * 手动最小化
  ...
  self.restore = function (id = '') {
    let el=document.querySelector('#' + id + ' .lv-icon-huanyuan')
    el&&el.click();
  }
